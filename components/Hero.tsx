    ...
    return (
        ...
        >
            <div className="max-w-5xl w-full space-y-8 text-center">
                ...
                <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-tight font-normal">
                    ...
                    <div className="relative inline-block mx-2">
                        <span className="relative z-10 hero-text">Mother.</span>
                        <span className="absolute inset-0 bg-black z-20 redacted-bar origin-right" />
                    </div>
                    <br />
                    <div className="relative inline-block mx-2">
                        <span className="relative z-10 hero-text">Small Business Owner.</span>
                        <span className="absolute inset-0 bg-black z-20 redacted-bar origin-right" />
                    </div>
                </h1>

                <div className="mt-12 max-w-2xl mx-auto hero-text opacity-0">
                    <p className="font-serif text-lg md:text-xl leading-relaxed">
                        <ContentRenderer content="Yvonne Williams built a legacy to protect her family. The system allowed ==scammers to steal it== while she was fighting for her life." />
                    </p>
                </div>
            </div>
